  ...
  function Accordion() {
    ...
    _this.renderChildren = function () {
      ...
      return Children.map(children, function (child) {
        ...
        if (isContent) {
          var isActive = _has(child, 'props.active') ? child.props.active : _this.isIndexActive(contentIndex);
          contentIndex++;
          return cloneElement(child, _extends({}, child.props, { active: isActive }));
        }
